...
export const POST = (request: Request) => createCatalogReferenceDataRouteHandlers(openCatalogReferenceDataServerApplication).createSpecificationDefinition(request);
