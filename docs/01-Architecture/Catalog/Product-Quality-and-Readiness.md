...
Publication requirements are resolved on every Smart Save and evaluated against the current Product Revision. Missing reasons preserve valid work rather than blocking persistence.

## العربية

### المتطلبات الحالية
تُحل متطلبات النشر في كل حفظ ذكي وتُقيّم مقابل Revision الحالي. تحفظ أسباب النقص العمل الصحيح بدلاً من منع الحفظ.
