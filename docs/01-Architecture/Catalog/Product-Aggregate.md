...
Product is the Aggregate Root. Its Value Objects include `ProductIdentity`, `ProductLifecycleState`, `ProductRevision`, `Money`, `ProductPricing`, `ProductSpecificationValue`, and Product Image identity/metadata.
