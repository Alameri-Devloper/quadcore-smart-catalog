...
- Search behavior and result presentation must be Responsive First, with purpose-designed Mobile, Tablet, and Desktop experiences as equally first-class environments and with touch, mouse, and keyboard navigation verified where applicable.
