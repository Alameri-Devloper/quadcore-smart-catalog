...
**Task 3.22-A6: Completed / merged through PR #35**, merge baseline `08e0d0dd0237c80ba52dcd12caec7f825ab2a5a6`. The [Implementation Report](../05-Development/Reports/QSC-Task-3.22-A6-Implementation-Report.md) preserves verification at implementation baseline `51562151d9be79b0f6be50c6406cb207c81e70aa`. The [post-A6 gate report](../05-Development/Reports/QSC-Task-3.22-Presentation-Gate-Reconciliation-Report.md) reconciles Presentation to **`ApprovedNextImplementation` — P1 only**, unstarted; P2–P8 need separate approval. The exact A6 API/permission/lifecycle contract below is unchanged; planning-session status and proposed file scope remain historical. | **اكتملت A6 ودُمجت عبر #35** عند خط الدمج المذكور. يحفظ تقرير التنفيذ تحقق خط التنفيذ السابق، ويصالح تقرير البوابة الواجهة إلى **`ApprovedNextImplementation` لشريحة P1 فقط** دون بدء التنفيذ؛ تحتاج P2–P8 اعتماداً مستقلاً. لم يتغير عقد A6 الدقيق للأغراض والصلاحيات ودورة الحياة، وتبقى حالة جلسة التخطيط ونطاق ملفاتها المقترح تاريخيين.
