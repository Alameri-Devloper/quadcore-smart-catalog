...
const messages: Readonly<Record<string, Translation>> = {
  ...
  recoveryDeferred: { ar: "خدمة الاستعادة غير متاحة مؤقتًا. حاول لاحقًا أو تواصل مع مالك مساحة العمل لإصدار كلمة مرور مؤقتة.", en: "Recovery is temporarily unavailable. Try later or contact a workspace Owner for a temporary password." },
  recoveryContinue: { ar: "متابعة إدخال الرمز", en: "Continue to code entry" },
  recoveryFlowMissing: { ar: "انتهت معلومات طلب الاستعادة في هذا المتصفح. ابدأ طلبًا جديدًا.", en: "This browser no longer has the recovery request information. Start a new request." },
  recoveryCodeRejected: { ar: "تعذر التحقق من الرمز. قد يكون غير صحيح أو منتهيًا أو غير صالح.", en: "The code could not be verified. It may be incorrect, expired, or no longer valid." },
  recoveryVerified: { ar: "تم التحقق من الرمز. اختر كلمة مرور جديدة لإكمال الاستعادة.", en: "Code verified. Choose a new password to complete recovery." },
  recoveryResetCompleted: { ar: "تم تغيير كلمة المرور وإلغاء الجلسات السابقة. عد إلى تسجيل الدخول.", en: "Password changed and previous sessions revoked. Return to sign in." },
  recoveryThrottled: { ar: "لا يمكن إعادة الإرسال الآن. انتظر ثم حاول مرة أخرى.", en: "Recovery cannot be resent yet. Wait and try again." },
  startRecoveryAgain: { ar: "بدء طلب استعادة جديد", en: "Start a new recovery request" },
