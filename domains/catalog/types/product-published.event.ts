...
export const PRODUCT_PUBLISHED_EVENT_NAME = "ProductPublished" as const;

export class ProductPublished implements DomainEvent {
  readonly eventName = PRODUCT_PUBLISHED_EVENT_NAME;
